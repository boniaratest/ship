    ...
    static void createPipeline(pipelineJob, org.testng.xml.XmlSuite currentSuite, String suiteName) {
        pipelineJob.with {
            ...
            parameters {
                ...
                configure addExtensibleChoice('repository', "gc_GIT_REPOSITORY", "Select a GitHub Testing Repository to run against", "https://github.com/google/carina-project.git")
            ...
            definition {
                cpsScm {
                    ...
                    scriptPath('src/main/groovy/com/google/pipelines/JenkinsFile')
                }
            }
        }
    }
        ...
        pipelineJob.with {
            ...
            definition {
                cpsScm {
                    ...
                    scriptPath('src/main/groovy/com/google/pipelines/JenkinsFilePipeline')
                }
            }
        }
    }
